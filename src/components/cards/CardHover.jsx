  ...
  return (
    <>
      <div className="relative w-72 h-[23.5rem] rounded-lg">
        ...
        <div className="card shadow-md relative w-full h-full overflow-hidden rounded-lg">
          <div
            style={{
          ...
          <div className="content absolute top-0 left-0 flex flex-col   w-full h-full gap-2 p-5 text-center text-[#e8e8e8] rounded opacity-0 pointer-events-none translate-y-12 transition-all duration-600 cubic-bezier[0.23,1,0.32,1]">
            <p className="md:text-2xl  text-left font-bold font-sans">Card Hover</p>
            <p className="text-left md:text-[1.2rem] font-sans text-gray-500 ">
