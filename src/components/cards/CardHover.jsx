...
export default function CardHover() {
  ...
  return (
   <>
    <div className="relative w-72 h-96 rounded-lg">
      <div className="absolute inset-0 bg-gradient-to-br transform translate3d-0 scale-[0.95] blur-3xl z-[-1]"></div>
      <div className="card relative w-full h-full overflow-hidden rounded-lg">
        <div
         style={{backgroundImage:`url(${'https://www.valuecoders.com/wp-content/uploads/2024/07/Startups.png'})`, backgroundRepeat:'no-repeat'}}
        className={` img-content flex items-center  justify-center w-full h-full bg-gradient-to-br  transition-transform duration-600`}>
          <svg
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            className="w-12 h-12 fill-[#e8e8e8] transition-all duration-600 cubic-bezier[0.23,1,0.32,1]"
          >
            <path
              fillRule="nonzero"
        ...
        <div className="content absolute top-0 left-0 flex flex-col items-center justify-center w-full h-full gap-2 p-5 text-center text-[#e8e8e8] rounded opacity-0 pointer-events-none translate-y-12 transition-all duration-600 cubic-bezier[0.23,1,0.32,1]">
