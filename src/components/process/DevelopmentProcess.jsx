  ...
  return (
    <>
      <div className="w-full pt-5 pb-9 bg-white">
        <div className=" text-black md:text-3xl text-xl md:mt-6 mt-4 font-sans font-semibold text-center">
          Process We Follow
        </div>

        <p className="text-center md:mt-4 mt-2">
            ...
            return (
              <>
                ...
                >
                  ...
                  <h1 className={`text-xl font-medium my-4 ${txtColor}`}>Planning</h1>
                  <p className={`md:text-base text-center ${txtColor}`}>{devdata.desc}</p>
                </div>
              </>
            );
          })}
