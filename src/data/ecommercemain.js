...
export const servicesData = {
  heading: "Transform Visitors into Shoppers with Our eCommerce Expertise",
  desc: `
  Our services handle everything from building your online store to keeping it running smoothly, making sure your eCommerce business grows effortlessly.
`,
  img: strategyimg,
  list: [
    {
      ...
      desc: `Experience the power of 24/7 availability, reduced overhead costs, and a global marketplace – all at your fingertips. Our custom eCommerce development services cater to your unique business, enhancing user experience and driving sales.`,
    },
    {
      id: 2,
      icon: secondicon,
      heading: "Website Design",
      desc: `Our website design experts create visually appealing, user-friendly eCommerce sites tailored to your brand, ensuring an engaging shopping experience that drives conversions.`,
    },
    {
      id: 3,
      icon: thirdicon,
      heading: "Consulting",
      desc: `Our eCommerce development company offers technical and advisory assistance to help businesses advance their users’ experiences via eCommerce platforms.`,
    },
    {
      id: 4,
      icon: fourthicon,
      heading: "Implementation",
      desc: `Our eCommerce implementation services integrate essential tools – cloud, payments, POS, CRM – into your web store and mobile app.`,
    },
    {
      id: 5,
      icon: fifthicon,
      heading: "Backend Development",
      desc: `From inventory management to payment processing, our eCommerce backend service provides a robust, scalable platform for all your business needs.`,
    },
    {
      id: 6,
      icon: sixthicon,
      heading: "Frontend Development",
      desc: `Our eCommerce application development company uses HTML, CSS, and JavaScript to create modern digital storefronts to offer a much-needed boost for your eCommerce store.`,
    },
    {
      id: 7,
      icon: seventhicon,
      heading: "Mobile App Development",
      desc: `We develop mobile eCommerce apps that ensure your online store reaches users on their mobile devices seamlessly, providing a convenient and engaging shopping experience.`,
    },
    {
      id: 8,
      icon: eighthicon,
    ...
    },
    {
      id: 11,
      icon: eleventhicon,
      heading: "eCommerce Audit",
      desc: `We provide comprehensive eCommerce audits, analyzing your site’s performance, security, and user experience. Our detailed reports and actionable insights help optimize your online store for better functionality and increased sales.`,
    },
    {
      id: 12,
      icon: twelfthicon,
...
export const domainExpertiseData = {
  heading: "eCommerce Development Services",
  desc: `Our comprehensive eCommerce development services help you build robust online stores and applications that cater to your unique business needs. We focus on enhancing user experience, driving sales, and ensuring seamless integration with essential tools.`,
  points: [
