...
At our web development company, we offer a variety of technologies for web development, including Node.js, PHP, Python, and Ruby on Rails. We may use one or multiple technologies to create a robust and scalable web solution depending on the project.
    ...
    },
    {
      id: 5,
      question:
        "How does Qurilo ensure the quality and security of web development projects?",
      answer: `Qurilo is committed to delivering high-quality and secure web development solutions. Here’s how we ensure it:`,
      // put list items here
      ansList: [
        {
          id: 1,
          heading: `Experienced Developers`,
          desc: `We have a team of experienced web developers with expertise in various technologies and frameworks. They follow coding best practices and industry standards to deliver reliable and robust solutions.`,
        },
        {
          id: 2,
          heading: `Quality Assurance`,
          desc: `We have a dedicated Quality Assurance (QA) team that conducts rigorous testing at every stage of the development process. This ensures that the web code is thoroughly tested for functionality, performance, and security.`,
        },
        {
          id: 3,
        ...
        },
        {
          ...
          desc: `We conduct regular code reviews to maintain quality and identify potential issues or improvements. This helps ensure the web code is clean, efficient, and maintainable.`,
        },
        {
          id: 5,
