...
export const faqData = [
  ...
  },
  {
    ...
    answer: (
      <span>
        ...
        <br />  Just fill out a form and <strong className="text-gray-900">connect with our team </strong>
  ...
  },
  {
    ...
    answer: (
      <span>
        The cost of <strong className="text-gray-900">outsource software development </strong> depends on
        several factors such as the size and build of the application, the
        features & third-party integrations, APIs, animations, localizations,
        backend, cross-platform toolsets, platforms, etc. If you share your
        basic idea, we can provide you with an ETA and estimated cost.
      </span>
    ),
  },
  {
    ...
    answer: (
      <span>
        ...
        <strong className="text-gray-900"> white-label software development services </strong> , including
  ...
  },
  {
    ...
    answer: (
      <span>
        <strong className="text-gray-900">Software product development outsourcing</strong> is not risky
        at all if you outsource your project to a reputed company. ValueCoders
        ensures IP (Intellectual Property) & data protection in the following
        ways:
      </span>
    ),
    list: [
  ...
  },
  {
    ...
    answer: (<span>At ValueCoders, we offer a variety of engagement models to suit your specific project requirements. Whether you need a dedicated team of coders for an ongoing project or just a few extra hands for a one-off task, we have an engagement model that will fit your needs.
        <br/><br />
        <strong className="text-gray-900">Dedicated Team:</strong>Dedicated team model comprises a PM, SW Engineer, QA Engineer, and other roles defined for each specific project.
        <br />
        <strong className="text-gray-900">Staff Augmentation: </strong>We provide extra talent to boost your specific projects. This extended team works as a part of your local team, attending your daily meetings and reporting directly to your manager.
        <br/>
        <strong className="text-gray-900">Offshore Development Center:</strong> We also provide a dedicated software development office with all required infrastructure and employees in India. Our ODC model helps you save budget and speed up development, recruiting, and optimizing accounting and HR.
        </span>),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <span>
        ...
        <strong className="text-gray-900">software outsourcing services</strong>. Here are a few reasons
        that give a competitive edge to India over Latin America, the
        Philippines, or Eastern Europe:
      </span>
    ),
    list: [
